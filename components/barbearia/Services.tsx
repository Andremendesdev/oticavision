...
export default function Services() {
  return (
    <section id="services" className="py-24 px-6 relative overflow-hidden" style={{ background: "#ffffff" }}>
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <span className="text-[9px] tracking-[0.35em] uppercase font-semibold block mb-4" style={{ color: "#ef4444" }}>
            Por que nos escolher
          </span>
          <h2 className="font-serif text-3xl sm:text-4xl font-bold uppercase tracking-wide" style={{ color: "#0f172a" }}>
            Nossos{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {BENEFITS.map((benefit, i) => (
            ...
            >
              ...
              <h3 className="text-sm md:text-base font-medium leading-relaxed max-w-[200px]" style={{ color: "#0f172a" }}>
                {benefit.title}
              </h3>
            </M.div>
          ))}
